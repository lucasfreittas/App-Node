...
const migrationsRun = require('./database/sqlite/migrations'); // Requisição do "index.js" que está dentro da pasta "sqlite" (mudamos o nome para migrations pq depois automatizamos a criação da db)
...
migrationsRun(); // Iniciando banco de dados
